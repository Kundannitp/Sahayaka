...
import com.pranks.doctalk.BuildConfig;
...
public class chatBot extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        v = inflater.inflate(R.layout.fragment_chat_bot, container, false);

        ((Home) getActivity()).getSupportActionBar().setTitle("ChatBot");
    ...
    public void showTextView(String message, int type) {
        ...
        switch (type) {
            case USER:
                ...
                ImageView img=layout.findViewById(R.id.person_ImageView);
                GoogleSignInAccount acct = GoogleSignIn.getLastSignedInAccount(getContext());
                Glide.with(getContext()).load(acct.getPhotoUrl()).into(img);
                break;
            case BOT:
                layout = getBotLayout();
                break;
